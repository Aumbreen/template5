    ...
    <section className="bg-[#ffffff] py-10">
      <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row justify-between items-center">
        ...
        <div className="flex gap-6 mt-6 lg:mt-0">
          <Image src="/logos_facebook (1).png" width={16} height={16}alt="fb"  />
          <Image src="/Vector (30).png" width={16} height={16} alt="insta"/>
          <Image src="/ant-design_twitter-outlined.png"  width={16} height={16}alt="twitter"  />
        </div>
      </div>
    </section>
